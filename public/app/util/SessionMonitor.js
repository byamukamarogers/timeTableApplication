 ...
 * logged out.
 */
Ext.define('TimeTableApp.util.SessionMonitor', {
  singleton: true,
  ...
  window: Ext.create('Ext.window.Window', {
    ...
    buttons: [{
      ...
      handler: function() {
        Ext.TaskManager.stop(TimeTableApp.util.SessionMonitor.countDownTask);
        TimeTableApp.util.SessionMonitor.window.hide();
        TimeTableApp.util.SessionMonitor.start();
        // 'poke' the server-side to update your session.
        Ext.Ajax.request({
          url: 'resources/php/sessionAlive.php'
        });
      }
    },{
      text: 'Logout',
